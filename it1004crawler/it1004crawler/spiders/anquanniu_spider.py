...
class FreeBufSpider(scrapy.Spider):
    ...
    def parse(self, response):
        news = response.xpath('//*[@id="content"]/div[1]')
        for new in news:
            new_url = new.css('h4 a::attr(href)').extract_first()
    ...
    def parse_article_link(self, response):
        ...
        article = response.xpath('/html/body/div[1]/div[2]')
        article_item['title'] = article.xpath(
            '/html/body/div[1]/div[2]/div/div[3]/div[1]/div[1]/h2/text()').extract()[0]
